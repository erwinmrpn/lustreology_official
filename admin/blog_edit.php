...
// Pastikan ada ID
if (!isset($_GET['id'])) {
    echo "<script>alert('ID tidak ditemukan!'); window.location='blog.php';</script>";
    exit;
}
...
$query = mysqli_query($conn, "SELECT * FROM blog WHERE id_blog = '$id'");
$data = mysqli_fetch_assoc($query);

if (!$data) {
    echo "<script>alert('Data blog tidak ditemukan!'); window.location='blog.php';</script>";
    exit;
}
?>
...
<body>
    ...
    <div class="content">
        ...
        <div class="card" style="padding:18px;">
            ...
            <div class="card" style="padding:18px; max-width:700px; margin:auto;">
                <h3>Edit Blog</h3>

                <form action="proses/blog_edit_proses.php" method="POST" enctype="multipart/form-data"
                    ...
                    <input type="text" name="deskripsi_singkat" value="<?= $data['deskripsi_singkat'] ?>">

                    <div style="margin-top:12px;">
                        <label>Deskripsi Panjang</label>
                        <textarea name="deskripsi_panjang" rows="6"><?= $data['deskripsi_lengkap'] ?></textarea>
                    </div>

                    <label style="margin-top:12px;">Gambar Saat Ini</label><br>
                    ...
                    <div style="margin-top:12px;">
                        ...
                        <small style="color:gray;">Jika tidak ingin mengubah gambar, kosongkan saja</small>
                    </div>

                    <div style="margin-top:14px;">
                        <button type="submit" class="btn btn-primary">Update</button>
                        <a href="blog.php" class="btn btn-secondary">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
